...
export default function ChatContainer() {
  ...
  return (
    <div className="w-full h-screen md:h-[95vh] md:max-w-[650px] flex flex-col bg-white dark:bg-[#1a1a1a] md:rounded-xl border-0 md:border md:border-[#2a2a2a] md:shadow-2xl overflow-hidden transition-colors">
      {/* Header */}
      <div className="bg-gradient-to-135 from-gray-100 to-gray-200 dark:from-[#1a1a1a] dark:to-[#252525] text-gray-900 dark:text-white px-6 py-6 border-b border-gray-200 dark:border-[#2a2a2a] flex justify-between items-center flex-shrink-0">
        <div>
        ...
        <div className="flex gap-2">
          ...
          >
            {theme === 'light' ? (
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" style={{ pointerEvents: 'none' }}>
